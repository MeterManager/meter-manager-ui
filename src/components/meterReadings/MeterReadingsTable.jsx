                  ...
                  <Table size="small">
                      <TableHead>
                          <TableRow>
                              ...
                              <TableCell align="center" sx={{ fontWeight: "bold" }}>Лічильник/Орендар</TableCell>
                              <TableCell align="center" sx={{ fontWeight: "bold" }}>Локація Орендаря</TableCell>
                      ...
                      <TableBody>
                          {readings.length > 0 ? (
                              readings.map((r) => {
                                  ...
                                  return (
                                      <TableRow key={r.id} hover>
                                          ...
                                          <TableCell align="center" sx={{ fontWeight: "bold" }}>{r.total_cost}</TableCell>
                              ...
                              <TableRow>
                                  <TableCell colSpan={14} align="center" sx={{ p: 2 }}>
                                      <Typography variant="body2" color="text.secondary">
                                          Показники не знайдено
                                      </Typography>
                                  </TableCell>
